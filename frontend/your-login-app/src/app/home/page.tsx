...
import { useSession, signOut } from "next-auth/react"; // Importando signOut
...
export default function Home() {
  const { data: session } = useSession();  // Pega a sessão ativa

  // Função de logout que será chamada quando o usuário clicar em "Sair"
  const handleLogout = () => {
    signOut({ callbackUrl: '/login' });  // Faz logout e redireciona para a página inicial (ou qualquer outra)
  };
        ...
        <nav className={styles.navBar}>
          ...
          <div className={styles.dropdown}>
            ...
            <div className={styles.dropdownContent}>
              ...
              {/* Aqui chamamos a função handleLogout ao clicar em "Sair" */}
